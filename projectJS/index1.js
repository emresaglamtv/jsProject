//Update
const div1 = document.getElementById("pUpdate");
const button1 = document.getElementById("updateButton");
button1.addEventListener("click", function(){
pUpdate.classList.toggle("colorp");
})

div1.classList.add("update");
const classNames1 = div1.classList;
document.getElementById("pUpdate").innerHTML="class eklendikten sonra ki liste:" + classNames1;
